...
* WebSocket: [https://github.com/genixcrypto/insight-api-genix#web-socket-api](https://github.com/genixcrypto/insight-api-genix#web-socket-api)
* API: [https://github.com/genixcrypto/insight-api-genix#instantsend-transactions](https://github.com/genixcrypto/insight-api-genix#instantsend-transactions)
...
By default, the GENIX Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the GENIX Core daemon:
