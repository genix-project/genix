...
## Update genix.conf on server

If you generated a new masternode private key, you will need to update the remote `genix.conf` files.
...
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `genix.conf` file.
...
and comparing with the official explorer at https://explorer.genix.org/chain/GENIX
