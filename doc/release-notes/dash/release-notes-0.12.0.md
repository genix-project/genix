...
backwards-compatible with pre-0.12 versions of genix Core or other software:
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/genix/).
