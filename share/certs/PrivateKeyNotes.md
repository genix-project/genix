...
unlocked to sign the GENIX-Qt.app bundle.
...
allowing somebody to distribute a GENIX-Qt.app or genix-qt-setup.exe with a valid
...
that the genix-qt.exe file inside the installer had not been tampered with.
