#!/usr/bin/env python3
# Copyright (c) 2015-2021 The Genix Core developers
...
class LLMQCoinbaseCommitmentsTest(genixTestFramework):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as genixTestFramework doesn't support this atm)
