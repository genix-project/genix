...
enum WalletFeature
{
    ...
    FEATURE_HD = 120210,    // Hierarchical key derivation after BIP32 (HD Wallet), BIP44 (multi-coin), BIP39 (mnemonic)
...
public:
    ...
    /// Get 1000genix output and keys which can be used for the Masternode
