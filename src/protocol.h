...
enum ServiceFlags : uint64_t {
    ...
    // genix Core does not support this but a patch set called Bitcoin XT does.
...
enum GetDataMsg {
    ...
    MSG_SPORK = 6,
    /* 7 - 15 were used in old genix versions and were mainly budget and MN broadcast/ping related*/
    MSG_DSTX = 16,
