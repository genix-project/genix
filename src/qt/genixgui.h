...
#ifndef GENIX_QT_GENIXGUI_H
#define GENIX_QT_GENIXGUI_H
...
/**
  GENIX GUI main class. This class represents the main window of the GENIX UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class GENIXGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit GENIXGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~GENIXGUI();
...
private Q_SLOTS:
    ...
    /** Open external (default) editor with genix.conf */
    void showConfEditor();
