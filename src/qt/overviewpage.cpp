...
public:
    TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(GENIXUnits::GENIX),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = GENIXUnits::floorWithUnit(unit, amount, true, GENIXUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& anonymizedBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(GENIXUnits::floorHtmlWithUnit(nDisplayUnit, balance, false, GENIXUnits::separatorAlways));
    ui->labelUnconfirmed->setText(GENIXUnits::floorHtmlWithUnit(nDisplayUnit, unconfirmedBalance, false, GENIXUnits::separatorAlways));
    ui->labelImmature->setText(GENIXUnits::floorHtmlWithUnit(nDisplayUnit, immatureBalance, false, GENIXUnits::separatorAlways));
    ui->labelAnonymized->setText(GENIXUnits::floorHtmlWithUnit(nDisplayUnit, anonymizedBalance, false, GENIXUnits::separatorAlways));
    ui->labelTotal->setText(GENIXUnits::floorHtmlWithUnit(nDisplayUnit, balance + unconfirmedBalance + immatureBalance, false, GENIXUnits::separatorAlways));
    ui->labelWatchAvailable->setText(GENIXUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance, false, GENIXUnits::separatorAlways));
    ui->labelWatchPending->setText(GENIXUnits::floorHtmlWithUnit(nDisplayUnit, watchUnconfBalance, false, GENIXUnits::separatorAlways));
    ui->labelWatchImmature->setText(GENIXUnits::floorHtmlWithUnit(nDisplayUnit, watchImmatureBalance, false, GENIXUnits::separatorAlways));
    ui->labelWatchTotal->setText(GENIXUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, GENIXUnits::separatorAlways));
...
void OverviewPage::updatePrivateSendProgress()
{
    ...
    QString strPrivateSendAmount = GENIXUnits::formatHtmlWithUnit(nDisplayUnit, privateSendClient.nPrivateSendAmount * COIN, false, GENIXUnits::separatorAlways);
    ...
    if(currentBalance == 0)
    {
        ...
        strPrivateSendAmount = strPrivateSendAmount.remove(strPrivateSendAmount.indexOf("."), GENIXUnits::decimals(nDisplayUnit) + 1);
    ...
    if(nMaxToAnonymize >= privateSendClient.nPrivateSendAmount * COIN) {
        ...
        QString strMaxToAnonymize = GENIXUnits::formatHtmlWithUnit(nDisplayUnit, nMaxToAnonymize, false, GENIXUnits::separatorAlways);
        ui->labelAmountRounds->setToolTip(tr("Not enough compatible inputs to anonymize <span style='color:red;'>%1</span>,<br>"
                                             "will anonymize <span style='color:red;'>%2</span> instead")
                                          .arg(strPrivateSendAmount)
                                          .arg(strMaxToAnonymize));
        strMaxToAnonymize = strMaxToAnonymize.remove(strMaxToAnonymize.indexOf("."), GENIXUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = "<span style='color:red;'>" +
                QString(GENIXUnits::factor(nDisplayUnit) == 1 ? "" : "~") + strMaxToAnonymize +
...
void OverviewPage::togglePrivateSend(){
    ...
    if(!privateSendClient.fEnablePrivateSend){
        ...
        if(currentBalance < nMinAmount){
            QString strMinAmount(GENIXUnits::formatWithUnit(nDisplayUnit, nMinAmount));
            QMessageBox::warning(this, tr("PrivateSend"),
