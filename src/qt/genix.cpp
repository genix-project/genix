...
{
    return QCoreApplication::translate("genix-core", psz).toStdString();
}
...
void BitcoinApplication::initializeResult(bool success)
{
    ...
    if(success)
    {
        ...
        // genix: URIs or payment requests:
...
int main(int argc, char *argv[])
{
    ...
    // genix: links repeatedly have their payment requests routed to this process:
