...
#ifndef GENIX_QT_GENIXUNITS_H
#define GENIX_QT_GENIXUNITS_H
...
/** GENIX unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GENIXUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GENIXUnits(QObject *parent);

    /** GENIX units.
      @note Source: https://en.genix.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        GENIX,
...
typedef GENIXUnits::Unit GENIXUnit;

#endif // GENIX_QT_GENIXUNITS_H
