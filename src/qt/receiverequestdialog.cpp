...
#include "config/genix-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatGENIXURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + GENIXUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatGENIXURI(info));
}
