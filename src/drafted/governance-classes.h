 ...
 *
 *   // network
 *   CGENIXNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.genix.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CGENIXNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: GENIXNetwork
// //   -- signature requirements : Key1(User)
// class CGENIXNetworkVariable : public CGovernanceObject
// {
// private:
