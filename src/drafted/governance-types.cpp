...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "GENIXNetwork") type = GENIXNetwork;
    if(strType == "GENIXNetworkVariable") type = GENIXNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == GENIXNetwork) s = "GENIXNetwork";
    if(type == GENIXNetworkVariable) s = "GENIXNetworkVariable";
