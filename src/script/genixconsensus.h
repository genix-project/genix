...
#ifndef GENIX_GENIXCONSENSUS_H
#define GENIX_GENIXCONSENSUS_H

#if defined(BUILD_GENIX_INTERNAL) && defined(HAVE_CONFIG_H)
#include "config/genix-config.h"
  ...
  #endif
#elif defined(MSC_VER) && !defined(STATIC_LIBGENIXCONSENSUS)
...
#define GENIXCONSENSUS_API_VER 0
