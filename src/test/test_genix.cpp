...
#define BOOST_TEST_MODULE GENIX Test Suite

#include "test_genix.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_genix_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
