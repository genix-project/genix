...
#ifndef GENIX_TEST_SCRIPTNUM10_H
#define GENIX_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from GENIX Core 0.10.0, for cross-comparison.
 */
public:
