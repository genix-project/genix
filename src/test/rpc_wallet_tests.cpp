...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CGENIXAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CGENIXAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey(0, false);
        demoAddress = CGENIXAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CGENIXAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CGENIXAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CGENIXAddress(arr[0].get_str()).Get() == demoAddress.Get());
