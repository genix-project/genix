# Linearize
Construct a linear, no-fork, best version of the genix blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install genix_hash

https://github.com/genix-project/genix_hash
...
JSON-RPC server. Running `genixd` or `genix-qt -server` will be sufficient.
...
* `input`: genixd blocks/ directory containing blkNNNNN.dat
